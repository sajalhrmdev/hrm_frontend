        ...
        <div className="d-flex my-xl-auto right-content align-items-center flex-wrap ">
          <div className="me-2 mb-2">
            <div className="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
              <Link href={routes.leadsList} className="btn btn-icon btn-sm me-1">
                <i className="ti ti-list-tree" />
              </Link>
              <Link
                href={routes.leadsGrid}
                ...
                <div className="card-body">
                  <div className="d-block">
                    ...
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <h6 className="fw-medium">
                        <Link href={routes.leadsDetails}>Chris Johnson</Link>
                      </h6>
                    </div>
                  </div>
                  <div className="mb-3 d-flex flex-column">
                ...
                <div className="card-body">
                  <div className="d-block">
                    ...
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <h6 className="fw-medium">
                        <Link href={routes.leadsDetails}>Emily Johnson</Link>
                      </h6>
                    </div>
                  </div>
                  <div className="mb-3 d-flex flex-column">
                ...
                <div className="card-body">
                  <div className="d-block">
                    ...
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <h6 className="fw-medium">
                        <Link href={routes.leadsDetails}>Maria Garcia</Link>
                      </h6>
                    </div>
                  </div>
                  <div className="mb-3 d-flex flex-column">
                ...
                <div className="card-body">
                  <div className="d-block">
                    ...
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <h6 className="fw-medium">
                        <Link href={routes.leadsDetails}>John Smith</Link>
                      </h6>
                    </div>
                  </div>
                  <div className="mb-3 d-flex flex-column">
                ...
                <div className="card-body">
                  <div className="d-block">
                    ...
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <h6 className="fw-medium">
                        <Link href={routes.leadsDetails}>David Lee</Link>
                      </h6>
                    </div>
                  </div>
                  <div className="mb-3 d-flex flex-column">
                ...
                <div className="card-body">
                  <div className="d-block">
                    ...
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <h6 className="fw-medium">
                        <Link href={routes.leadsDetails}>Robert Martinez</Link>
                      </h6>
                    </div>
                  </div>
                  <div className="mb-3 d-flex flex-column">
                ...
                <div className="card-body">
                  <div className="d-block">
                    ...
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <h6 className="fw-medium">
                        <Link href={routes.leadsDetails}>Michael Brown</Link>
                      </h6>
                    </div>
                  </div>
                  <div className="mb-3 d-flex flex-column">
                ...
                <div className="card-body">
                  <div className="d-block">
                    ...
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <h6 className="fw-medium">
                        <Link href={routes.leadsDetails}>Karen Davis</Link>
                      </h6>
                    </div>
                  </div>
                  <div className="mb-3 d-flex flex-column">
                ...
                <div className="card-body">
                  <div className="d-block">
                    ...
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <h6 className="fw-medium">
                        <Link href={routes.leadsDetails}>James Anderson</Link>
                      </h6>
                    </div>
                  </div>
                  <div className="mb-3 d-flex flex-column">
...
export default LeadsGridComponent