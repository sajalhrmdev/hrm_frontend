                    ...
                    <div className="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                      ...
                      <div className="d-flex align-items-center">
                        <div className="dropdown me-2">
                          <Link
                            href="#"
                            className="dropdown-toggle btn btn-sm bg-danger-transparent border-0 h-none"
                            data-bs-toggle="dropdown"
                            aria-expanded="false"
                          >
                            Busy
                    ...
                    <div className="d-flex align-items-center justify-content-between flex-wrap row-gap-3 mb-3">
                      ...
                      <div className="d-flex align-items-center">
                        <div className="dropdown me-2">
                          <Link
                            href="#"
                            className="dropdown-toggle btn btn-sm bg-transparent-purple border-0 h-none"
                            data-bs-toggle="dropdown"
                            aria-expanded="false"
                          >
                            No Answer
