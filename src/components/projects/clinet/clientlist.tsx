...
const ClientList = () => {
  const data: ClientRecord[] = clientlistdetails;
  const columns: ColumnType<ClientRecord>[] = [
    {
      title: "Client ID",
      dataIndex: "ClientID",
      render: (_text: string, record: ClientRecord) => (
        <Link href={all_routes.clientdetils}>{record.ClientID}</Link>
      ),
        ...
        <div className="d-flex align-items-center file-name-icon">
          ...
          <div className="ms-2">
            <h6 className="fw-medium">
              <Link href={all_routes.clientdetils}>{record.ClientName}</Link>
            </h6>
            ...
            <div className="d-flex my-xl-auto right-content align-items-center flex-wrap ">
              <div className="me-2 mb-2">
                <div className="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
                  <Link
                    href={all_routes.clientlist}
                    className="btn btn-icon btn-sm active bg-primary text-white me-1"
                  >
                    <i className="ti ti-list-tree" />
                  </Link>
                  <Link
                    href={all_routes.clientgrid}
