...
import LeavesDonutChart from "@/components/chart/mainMenuCharts/employee-dashboard/leavesDonutChart";
import PerformanceChart2 from "@/components/chart/mainMenuCharts/employee-dashboard/performanceChart2";
...
const EmployeeDashboardComponent = () => {
  ...
  const getModalContainer = (node: HTMLElement): HTMLElement => {
    if (typeof window === "undefined") {
      return node; // Return the trigger node during SSR
    }
          ...
          <div className="content">
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
              ...
              <div className="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                ...
                <div className="input-icon-end position-relative mb-2">
                  <DatePicker
                      ...
                      <div className="col-md-12">
                        <div>
                          <p className="d-flex align-items-center gap-2">
                            <span className="square-icon rounded bg-primary">
                              <i className="ti ti-check text-white fs-10 fw-bold" />
                            </span>
                ...
                <div className="card flex-fill">
                  ...
                  <div className="card-body">
                    <div>
                      ...
                      <div id="performance_chart2"style={{ height: '288px'}}>
                        <PerformanceChart2 />
                      </div>
                    </div>
                  </div>
                    ...
                    <div>
                      <div className="border border-dashed bg-transparent-light rounded p-2 mb-2">
                        <div className="d-flex align-items-center justify-content-between">
                          <div className="d-flex align-items-center">
                            <span className="d-block border border-2 h-12 border-primary rounded-5 me-2 left-line" />
                            <div>
                      ...
                      <div className="border border-dashed bg-transparent-light rounded p-2 mb-2">
                        <div className="d-flex align-items-center justify-content-between">
                          <div className="d-flex align-items-center">
                            <span className="d-block border border-2 h-12 border-success rounded-5 me-2 left-line" />
                            <div>
                      ...
                      <div className="border border-dashed bg-transparent-light rounded p-2 mb-2">
                        <div className="d-flex align-items-center justify-content-between">
                          <div className="d-flex align-items-center">
                            <span className="d-block border border-2 h-12 border-purple rounded-5 me-2 left-line" />
                            <div>
                      ...
                      <div className="border border-dashed bg-transparent-light rounded p-2 mb-2">
                        <div className="d-flex align-items-center justify-content-between">
                          <div className="d-flex align-items-center">
                            <span className="d-block border border-2 h-12 border-info rounded-5 me-2 left-line" />
                            <div>
                      ...
                      <div className="border border-dashed bg-transparent-light rounded p-2">
                        <div className="d-flex align-items-center justify-content-between">
                          <div className="d-flex align-items-center">
                            <span className="d-block border border-2 h-12 border-dark rounded-5 me-2 left-line" />
                            <div>
                ...
                <div className="flex-fill">
                  ...
                  <div className="card bg-secondary mb-3">
                    <div className="card-body d-flex align-items-center justify-content-between p-3">
                      ...
                      <Link href="#" className="btn btn-white btn-sm px-3">
                        View All
                      </Link>
                    </div>
                  </div>
