          ...
          <div className="row align-items-center mb-4">
            <div className="d-md-flex d-sm-block justify-content-between align-items-center flex-wrap">
              <h6 className="fw-medium d-inline-flex align-items-center mb-3 mb-sm-0">
                <Link href={all_routes.projectlist}>
                    ...
                    >
                      <div className="accordion-body">
                        <div className="media-images-slider owl-carousel">
                          <Link
                            href="assets/img/media/media-big-08.jpg"
                          ...
                          <Link
                            href="assets/img/media/media-big-09.jpg"
                            data-fancybox="gallery"
                            className="gallery-item"
                          >
                            <ImageWithBasePath
                          ...
                          <Link
                            href="assets/img/media/media-big-10.jpg"
                            data-fancybox="gallery"
                            className="gallery-item"
                          >
                            <ImageWithBasePath
                          ...
                          <Link
                            href="assets/img/media/media-big-11.jpg"
                            data-fancybox="gallery"
                            className="gallery-item"
                          >
                            <ImageWithBasePath
                          ...
                          <Link
                            href="assets/img/media/media-big-12.jpg"
                            data-fancybox="gallery"
                            className="gallery-item"
                          >
                            <ImageWithBasePath
                          ...
                          <Link
                            href="assets/img/media/media-big-13.jpg"
                            data-fancybox="gallery"
                            className="gallery-item"
                          >
                            <ImageWithBasePath
                          ...
                          <Link
                            href="assets/img/media/media-big-14.jpg"
                            data-fancybox="gallery"
                            className="gallery-item"
                          >
                            <ImageWithBasePath
