...
export const SidebarDataTest = [
  {
    ...
    submenuItems: [
      ...
      {
        label: "Mobile Themes",
        link: routes.superAdminMobileThemes,
        base: routes.superAdminMobileThemes,
        submenu: false,
        showSubRoute: false,
        icon: "device-mobile",
        materialicons: "confirmation_number",
      ...
      {
        label: "Help Articles",
        link: routes.superAdminHelpArticles,
        base: routes.superAdminHelpArticles,
        submenu: false,
        showSubRoute: false,
        icon: "help-circle",
        materialicons: "confirmation_number",
    ...
    submenuItems: [
      {
        ...
        submenuItems: [
          ...
          },
          {
            ...
            // icon: "calendar-event",
            materialicons: "confirmation_number",
            permission: "Sidebar Designation",
            submenuItems: [],
          },
          {
            label: "Role",
          ...
          },
          {
           ...
           {
            label: "Reward Manage",
            link: routes.rewardManage,
            base: routes.rewardManage,
            submenu: false,
            showSubRoute: false,
            // icon: "calendar-event",
            materialicons: "confirmation_number",
        ...
        submenuItems: [
          ...
          },
          {
            ...
            // icon: "calendar-event",
            materialicons: "confirmation_number",
            permission: "Sidebar Attendance Regularization",
            submenuItems: [],
          },
          {
          ...
          {
            label: "Settings",
            link: "attendancesettings",
            base: "attendancesettings",
            submenu: true,
            showSubRoute: false,
            // icon: "calendar-event",
            materialicons: "confirmation_number",
      ...
      },
      {
        ...
        icon: "calendar-plus",
        materialicons: "confirmation_number",
        permission: "Sidebar Appointment",
        submenuItems: [],
      },
      {
        label: "Visit Manage",
        ...
        icon: "route",
        materialicons: "confirmation_number",
        permission: "Sidebar Visit",
        submenuItems: [],
      },
      {
        label: "Meeting Manage",
        link: routes.meeting,
        base: routes.meeting,
        submenu: false,
        showSubRoute: false,
        icon: "video",
        materialicons: "confirmation_number",
        permission: "Sidebar Meeting",
        submenuItems: [],
      },
      {
        label: "Project Manage",
        link: routes.projectManage,
        base: routes.projectManage,
        submenu: false,
        showSubRoute: false,
        icon: "briefcase",
        materialicons: "confirmation_number",
        permission: "Sidebar Project",
        submenuItems: [],
      },
       {
            label: "Report",
            ...
            submenuItems: [
              {
                ...
                link: routes.attendancesReport,
                base: routes.attendancesReport,
                submenu: false,
                showSubRoute: false,
                // icon: "calendar-event",
                materialicons: "confirmation_number",
  ...
  },
  {
    ...
    submenuItems: [
      ...
      {
        label: "My Meetings",
        link: routes.myMeeting,
        base: routes.myMeeting,
        submenu: false,
        showSubRoute: false,
        icon: "video",
        materialicons: "confirmation_number",
      ...
      {
        label: "My Projects",
        link: routes.myProject,
        base: routes.myProject,
        submenu: false,
        showSubRoute: false,
        icon: "briefcase",
        materialicons: "confirmation_number",
      ...
      },
      {
        ...
        submenuItems: [
          {
            label: "My Route History",
            link: routes.fieldMyRouteHistory,
            base: routes.fieldMyRouteHistory,
            submenu: false,
            showSubRoute: false,
            submenuItems: [],
          },
          {
            label: "Live Location",
            link: routes.fieldMyLocation,
            base: routes.fieldMyLocation,
            submenu: false,
            showSubRoute: false,
            submenuItems: [],
          },
  ...
  //           link: routes.certificationTracking,
  //           base: "certificationTracking",
  //           newBadge: true,
  //         },
  //         {
  //           label: "Learning Analytics",
  //           link: routes.learningAnalytics,
  ...
  //           base: routes.hrDashboard,
  //           newBadge: true,
  //         },
  //         {
  //           label: "Payroll Dashboard",
  //           link: routes.payrollDashboard,
  //           base: routes.payrollDashboard,
  //           newBadge: true,
  //         },
  //         {
  //           label: "Recruitment Dashboard",
  //           link: routes.recruitmentDashboard,
  //           base: routes.recruitmentDashboard,
  //           newBadge: true,
  //         },
  //         {
  //           label: "Attendance Dashboard",
  //           link: routes.attendanceDashboard,
  //           base: routes.attendanceDashboard,
  //           newBadge: true,
  //         },
  //         {
  //           label: "Finance Dashboard",
  //           link: routes.financeDashboard,
  //           base: routes.financeDashboard,
  //           newBadge: true,
  //         },
  //         {
  //           label: "IT Admin Dashboard",
  //           link: routes.itAdminDashboard,
  //           base: routes.itAdminDashboard,
  //           newBadge: true,
  //         },
  //         {
  //           label: "Asset Dashboard",
  //           link: routes.assetDashboard,
  //           base: routes.assetDashboard,
  //           newBadge: true,
  //         },
  //         {
  //           label: "Help Desk Dashboard",
  //           link: routes.helpDeskDashboard,
  //           base: routes.helpDeskDashboard,
  //           newBadge: true,
  //         },
  //       ],
  //     },
  ...
  //       showSubRoute: false,
  //       icon: "file-text",
  //       link: "https://smarthr.co.in/demo/react/documentation/nextjs.html",
  //       base: "1",
  //       materialicons: "description",
  //       target: "_blank",
  //       submenuItems: [],
  ...
  //       submenu: false,
  //       showSubRoute: false,
  //       link: "https://smarthr.co.in/demo/react/documentation/changelog.html",
  //       icon: "exchange",
  //       base: "1",
  //       materialicons: "sync_alt",
  //       target: "_blank",
