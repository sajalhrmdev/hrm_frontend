...
const PayrollSlipPage = () => {
  ...
  const earnings =
    data.payrollSnapComponents.filter(
      (item) =>
        item.type ===
        "EARNING"
    );
            ...
            (_, index) => {
              ...
              return (
                ...
                <tr key={index}>
                  ...
                  <td>
                    {earning
                      ? `₹${earning.standardAmount.toLocaleString()}`
                      : ""}
                  </td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              ₹
              {data.overtime_amount.toLocaleString()}
