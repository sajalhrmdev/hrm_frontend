              ...
              <div className="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                <div className="me-2 mb-2">
                  <div className="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
                    <Link href={routes.tickets} className="btn btn-icon btn-sm me-1">
              ...
              <div className="col-xl-3 col-lg-4 col-md-6">
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="text-center mb-3">
                      <h6 className="mb-1">
                        <Link href={routes.ticketDetails}>Display Glitch</Link>
                      </h6>
                      <span className="badge bg-info-transparent fs-10 fw-medium">
                        Tic - 005
                      </span>
              ...
              <div className="col-xl-3 col-lg-4 col-md-6">
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="text-center mb-3">
                      <h6 className="mb-1">
                        <Link href={routes.ticketDetails}>Security Alert</Link>
                      </h6>
                      <span className="badge bg-info-transparent fs-10 fw-medium">
                        Tic - 006
                      </span>
              ...
              <div className="col-xl-3 col-lg-4 col-md-6">
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="text-center mb-3">
                      <h6 className="mb-1">
                        <Link href={routes.ticketDetails}>Connectivity Issue</Link>
                      </h6>
                      <span className="badge bg-info-transparent fs-10 fw-medium">
                        Tic - 007
                      </span>
              ...
              <div className="col-xl-3 col-lg-4 col-md-6">
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="text-center mb-3">
                      <h6 className="mb-1">
                        <Link href={routes.ticketDetails}>Update Error</Link>
                      </h6>
                      <span className="badge bg-info-transparent fs-10 fw-medium">
                        Tic - 008
                      </span>
              ...
              <div className="col-xl-3 col-lg-4 col-md-6">
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="text-center mb-3">
                      <h6 className="mb-1">
                        <Link href={routes.ticketDetails}>Login Failure</Link>
                      </h6>
                      <span className="badge bg-info-transparent fs-10 fw-medium">
                        Tic - 009
                      </span>
              ...
              <div className="col-xl-3 col-lg-4 col-md-6">
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="text-center mb-3">
                      <h6 className="mb-1">
                        <Link href={routes.ticketDetails}>Server Timeout</Link>
                      </h6>
                      <span className="badge bg-info-transparent fs-10 fw-medium">
                        Tic - 010
                      </span>
              ...
              <div className="col-xl-3 col-lg-4 col-md-6">
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="text-center mb-3">
                      <h6 className="mb-1">
                        <Link href={routes.ticketDetails}>Email Client Setup</Link>
                      </h6>
                      <span className="badge bg-info-transparent fs-10 fw-medium">
                        Tic - 011
                      </span>
              ...
              <div className="col-xl-3 col-lg-4 col-md-6">
                <div className="card">
                  <div className="card-body">
                    ...
                    <div className="text-center mb-3">
                      <h6 className="mb-1">
                        <Link href={routes.ticketDetails}>Application Crashing</Link>
                      </h6>
                      <span className="badge bg-info-transparent fs-10 fw-medium">
                        Tic - 012
                      </span>
