        ...
        <div className="d-flex my-xl-auto right-content align-items-center flex-wrap ">
          <div className="me-2 mb-2">
            <div className="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
              <Link href={all_routes.contactList} className="btn btn-icon btn-sm me-1">
          ...
          <div className="card">
            <div className="card-body">
              ...
              <div className="text-center mb-3">
                <h6 className="mb-1">
                  <Link href={all_routes.contactDetails}>Darlee Robertson</Link>
                </h6>
        ...
        <div className="col-xl-3 col-lg-4 col-md-6">
          <div className="card">
            <div className="card-body">
              ...
              <div className="text-center mb-3">
                <h6 className="mb-1">
                  <Link href={all_routes.contactDetails}>Sharon Roy</Link>
                </h6>
                <span className="badge bg-pink-transparent fs-10 fw-medium">
                  Installer
                </span>
        ...
        <div className="col-xl-3 col-lg-4 col-md-6">
          <div className="card">
            <div className="card-body">
              ...
              <div className="text-center mb-3">
                <h6 className="mb-1">
                  <Link href={all_routes.contactDetails}>Vaughan Lewis</Link>
                </h6>
                <span className="badge bg-pink-transparent fs-10 fw-medium">
                  Senior Manager
                </span>
        ...
        <div className="col-xl-3 col-lg-4 col-md-6">
          <div className="card">
            <div className="card-body">
              ...
              <div className="text-center mb-3">
                <h6 className="mb-1">
                  <Link href={all_routes.contactDetails}>Jessica Louise</Link>
                </h6>
                <span className="badge bg-pink-transparent fs-10 fw-medium">
                  Test Engineer
                </span>
        ...
        <div className="col-xl-3 col-lg-4 col-md-6">
          <div className="card">
            <div className="card-body">
              ...
              <div className="text-center mb-3">
                <h6 className="mb-1">
                  <Link href={all_routes.contactDetails}>Carol Thomas</Link>
                </h6>
                <span className="badge bg-pink-transparent fs-10 fw-medium">
                  UI /UX Designer
                </span>
        ...
        <div className="col-xl-3 col-lg-4 col-md-6">
          <div className="card">
            <div className="card-body">
              ...
              <div className="text-center mb-3">
                <h6 className="mb-1">
                  <Link href={all_routes.contactDetails}>Dawn Mercha</Link>
                </h6>
                <span className="badge bg-pink-transparent fs-10 fw-medium">
                  UI /UX Designer
                </span>
        ...
        <div className="col-xl-3 col-lg-4 col-md-6">
          <div className="card">
            <div className="card-body">
              ...
              <div className="text-center mb-3">
                <h6 className="mb-1">
                  <Link href={all_routes.contactDetails}>Rachel Hampton</Link>
                </h6>
                <span className="badge bg-pink-transparent fs-10 fw-medium">
                  Software Developer
                </span>
        ...
        <div className="col-xl-3 col-lg-4 col-md-6">
          <div className="card">
            <div className="card-body">
              ...
              <div className="text-center mb-3">
                <h6 className="mb-1">
                  <Link href={all_routes.contactDetails}>Jonelle Curtiss</Link>
                </h6>
                <span className="badge bg-pink-transparent fs-10 fw-medium">
                  Supervisor
                </span>
        ...
        <div className="col-xl-3 col-lg-4 col-md-6">
          <div className="card">
            <div className="card-body">
              ...
              <div className="text-center mb-3">
                <h6 className="mb-1">
                  <Link href={all_routes.contactDetails}>Jonathan Smith</Link>
                </h6>
                <span className="badge bg-pink-transparent fs-10 fw-medium">
                  Team Lead Dev
                </span>
        ...
        <div className="col-xl-3 col-lg-4 col-md-6">
          <div className="card">
            <div className="card-body">
              ...
              <div className="text-center mb-3">
                <h6 className="mb-1">
                  <Link href={all_routes.contactDetails}>Patricia Carter</Link>
                </h6>
                <span className="badge bg-pink-transparent fs-10 fw-medium">
                  Team Lead Dev
                </span>
        ...
        <div className="col-xl-3 col-lg-4 col-md-6">
          <div className="card">
            <div className="card-body">
              ...
              <div className="text-center mb-3">
                <h6 className="mb-1">
                  <Link href={all_routes.contactDetails}>Jeffrey Jarrett</Link>
                </h6>
                <span className="badge bg-pink-transparent fs-10 fw-medium">
                  Team Lead Dev
                </span>
        ...
        <div className="col-xl-3 col-lg-4 col-md-6">
          <div className="card">
            <div className="card-body">
              ...
              <div className="text-center mb-3">
                <h6 className="mb-1">
                  <Link href={all_routes.contactDetails}>Gloria Rubio</Link>
                </h6>
                <span className="badge bg-pink-transparent fs-10 fw-medium">
                  Team Lead Dev
                </span>
