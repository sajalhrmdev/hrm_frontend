...
//       map.get(policy.id).employees.push(emp);
//     });
...
//     selectedPolicy.employees.forEach((emp: any) => {
...
//       map.get(shift.id).employees.push(emp);
//     });
...
//   const toggleAll = () => {
//     const ids = visibleEmployees.map((e: any) => e.id);
//     const allSelected =
//       ids.length > 0 &&
...
//                           <tr>
//                             <th width="60" className="ps-4 py-3">
//                               <input
//                                 type="checkbox"
...
export default function AdminAttendancePage() {
  ...
  const shiftGroups = useMemo(() => {
    ...
    const attendanceType = String(selectedPolicy.attendanceType || "").toUpperCase();
  ...
  const toggleAll = () => {
    ...
    const allSelected =
      ids.length > 0 && ids.every((id: number) => selectedEmployees.includes(id));
                  ...
                  <div>
                    <div className="d-flex align-items-center gap-2 mb-2">
                      ...
                      <div>
                        ...
                        <div className="text-muted small">
                          Manage attendance by policy and shift with a clean premium view
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="col-12 col-md-6 col-xl-4" key={policy.id}>
                        <div
                          ...
                          onMouseEnter={(e) => {
                            ...
                            el.style.boxShadow = "0 18px 40px rgba(15,23,42,0.12)";
                          }}
                          onMouseLeave={(e) => {
                            const el = e.currentTarget as HTMLDivElement;
                            el.style.transform = "translateY(0px)";
                            el.style.boxShadow = "0 10px 24px rgba(15,23,42,0.06)";
                          }}
                          onClick={() => {
                  ...
                  <div className="card-body p-4">
                    <div className="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center gap-3">
                      <div>
                        ...
                        <h5 className="fw-bold mb-1">{selectedShift.title}</h5>
                        <div className="text-muted small">
                          Select employees and mark attendance for {selectedDate}
                        </div>
                      </div>
