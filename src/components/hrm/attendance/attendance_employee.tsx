...
const AttendanceEmployeeComponent = () => {
...
const fetchTodayAttendance = async () => {
  ...
  const todayData = list.find((item: any) =>
    item.userId === 2 &&
...
const handleCheckOut = async () => {
  ...
  <p>
    Status: <b>{attendance?.status || "Not Marked"}</b>
  </p>
      ...
      Check Out
          ...
          <div className="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
            <div className="my-auto mb-2">
              <h2 className="mb-1">Employee Attendanceeeee</h2>
              <nav>
            ...
            <div className="d-flex my-xl-auto right-content align-items-center flex-wrap ">
              <div className="me-2 mb-2">
                <div className="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
                  ...
                  <Link href={all_routes.attendanceadmin} className="btn btn-icon btn-sm">
...
export default AttendanceEmployeeComponent
