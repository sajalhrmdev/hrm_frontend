...
const CronjobscheduleComponent = () => {
                        ...
                        <div className="modal-content">
                            <div className="modal-body text-center">
                                ...
                                <div className="d-flex justify-content-center">
                                    ...
                                    <Link href={routes.Cronjobschedule} className="btn btn-danger">
                                        Yes, Delete
                                    </Link>
                                </div>
                            </div>
...
export default CronjobscheduleComponent;
