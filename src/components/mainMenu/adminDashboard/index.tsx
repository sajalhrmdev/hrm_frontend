                ...
                <div className="col-md-3 d-flex">
                  <div className="card flex-fill">
                    <div className="card-body">
                      ...
                      <Link href={all_routes.attendanceemployee} className="link-default">
                        View Details
                      </Link>
                    </div>
                  </div>
                ...
                <div className="col-md-3 d-flex">
                  <div className="card flex-fill">
                    <div className="card-body">
                      ...
                      <Link href={all_routes.project} className="link-default">
                        View All
                      </Link>
                    </div>
                  </div>
                ...
                <div className="col-md-3 d-flex">
                  <div className="card flex-fill">
                    <div className="card-body">
                      ...
                      <Link href={all_routes.clientlist} className="link-default">
                        View All
                      </Link>
                    </div>
                  </div>
                ...
                <div className="col-md-3 d-flex">
                  <div className="card flex-fill">
                    <div className="card-body">
                      ...
                      <Link href={all_routes.tasks} className="link-default">
                        View All
                      </Link>
                    </div>
                  </div>
                ...
                <div className="col-md-3 d-flex">
                  <div className="card flex-fill">
                    <div className="card-body">
                      ...
                      <Link href={all_routes.expenses} className="link-default">
                        View All
                      </Link>
                    </div>
                  </div>
                ...
                <div className="col-md-3 d-flex">
                  <div className="card flex-fill">
                    <div className="card-body">
                      ...
                      <Link href={all_routes.superAdminPurchaseTransaction} className="link-default">
                        View All
                      </Link>
                    </div>
                  </div>
                ...
                <div className="col-md-3 d-flex">
                  <div className="card flex-fill">
                    <div className="card-body">
                      ...
                      <Link href={all_routes.joblist} className="link-default">
                        View All
                      </Link>
                    </div>
                  </div>
                ...
                <div className="col-md-3 d-flex">
                  <div className="card flex-fill">
                    <div className="card-body">
                      ...
                      <Link href={all_routes.candidateslist} className="link-default">
                        View All
                      </Link>
                    </div>
                  </div>
            ...
            <div className="col-xxl-4 d-flex">
              <div className="card flex-fill">
                ...
                <div className="card-body">
                    ...
                    <div className="d-flex align-items-center overflow-hidden">
                      ...
                      <div>
                        <h6 className="text-truncate mb-1 fs-14 fw-medium">
                          <Link href={all_routes.employeedetails}>Daniel Esbella</Link>
                        </h6>
                  ...
                  <Link href={all_routes.employeeList} className="btn btn-light btn-md w-100">
                    View All Employees
                  </Link>
                </div>
              </div>
                ...
                <div className="card-body">
                  <div>
                    <div className="d-flex align-items-center justify-content-between mb-3 p-2 border border-dashed br-5">
                      ...
                      <div className="d-flex align-items-center">
                        <Link href="#" className="link-default me-2">
                  ...
                  <Link
                    href={all_routes.attendancereport}
            ...
            <div className="col-xxl-4 d-flex">
              <div className="card flex-fill">
                <div className="card-header pb-2 d-flex align-items-center justify-content-between flex-wrap">
                  ...
                  <Link href={all_routes.joblist} className="btn btn-light btn-md mb-2">
                    View All
                  </Link>
                </div>
                <div className="card-body">
                  ...
                  <div className="tab-content">
                    <div className="tab-pane fade" id="openings">
                        ...
                        <div className="d-flex align-items-center">
                          ...
                          <div className="ms-2 overflow-hidden">
                            <p className="text-dark fw-medium text-truncate mb-0">
                              <Link href="#">Senior IOS Developer</Link>
                            </p>
                      ...
                      <div className="d-flex align-items-center justify-content-between mb-4">
                        <div className="d-flex align-items-center">
                          ...
                          <div className="ms-2 overflow-hidden">
                            <p className="text-dark fw-medium text-truncate mb-0">
                              <Link href="#">Junior PHP Developer</Link>
                            </p>
                      ...
                      <div className="d-flex align-items-center justify-content-between mb-4">
                        <div className="d-flex align-items-center">
                          ...
                          <div className="ms-2 overflow-hidden">
                            <p className="text-dark fw-medium text-truncate mb-0">
                              <Link href="#">Junior React Developer </Link>
                            </p>
                      ...
                      <div className="d-flex align-items-center justify-content-between mb-0">
                        <div className="d-flex align-items-center">
                          ...
                          <div className="ms-2 overflow-hidden">
                            <p className="text-dark fw-medium text-truncate mb-0">
                              <Link href="#">Senior Laravel Developer</Link>
                            </p>
                    ...
                    <div className="tab-pane fade show active" id="applicants">
                      <div className="d-flex align-items-center justify-content-between mb-4">
                        <div className="d-flex align-items-center">
                          <Link href="#" className="avatar overflow-hidden flex-shrink-0">
                            <ImageWithBasePath
            ...
            <div className="col-xxl-4 col-xl-6 d-flex">
              <div className="card flex-fill">
                <div className="card-header pb-2 d-flex align-items-center justify-content-between flex-wrap">
                  ...
                  <Link href={all_routes.employeeList} className="btn btn-light btn-md mb-2">
                    View All
                  </Link>
                </div>
                  ...
                  <div className="table-responsive">
                    <table className="table table-nowrap mb-0">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <Link href={all_routes.projectdetails} className="link-default">
                              PRO-001
                            </Link>
                          </td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td>
                            <h6 className="fw-medium">
                              <Link href={all_routes.projectdetails}>Clinic Management </Link>
                            </h6>
                          </td>
                          <td>
                            <div className="avatar-list-stacked avatar-group-sm">
            ...
            <div className="col-xxl-4 d-flex">
              <div className="card flex-fill">
                <div className="card-header pb-2 d-flex align-items-center justify-content-between flex-wrap">
                  ...
                  <Link href={all_routes.candidateslist} className="btn btn-light btn-md mb-2">
                    View All
                  </Link>
                </div>
                <div className="card-body">
            ...
            <div className="col-xxl-4 col-xl-6 d-flex">
              <div className="card flex-fill">
                <div className="card-header pb-2 d-flex align-items-center justify-content-between flex-wrap">
                  ...
                  <Link href={all_routes.activity} className="btn btn-light btn-md mb-2">
                    View All
                  </Link>
                </div>
                <div className="card-body">
                        ...
                        <div className="ms-2 flex-fill">
                          <div className="d-flex align-items-center justify-content-between">
                            <h6 className="fs-medium text-truncate">
                              <Link href="javscript:void(0);">Matt Morgan</Link>
                            </h6>
                    ...
                    <div className="d-flex justify-content-between">
                      <div className="d-flex align-items-center w-100">
                        ...
                        <div className="ms-2 flex-fill">
                          <div className="d-flex align-items-center justify-content-between">
                            <h6 className="fs-medium text-truncate">
                              <Link href="javscript:void(0);">Jay Ze</Link>
                            </h6>
                    ...
                    <div className="d-flex justify-content-between">
                      <div className="d-flex align-items-center w-100">
                        ...
                        <div className="ms-2 flex-fill">
                          <div className="d-flex align-items-center justify-content-between">
                            <h6 className="fs-medium text-truncate">
                              <Link href="javscript:void(0);">Mary Donald</Link>
                            </h6>
                            <p className="fs-13">05:30 PM</p>
                          </div>
                    ...
                    <div className="d-flex justify-content-between">
                      <div className="d-flex align-items-center w-100">
                        ...
                        <div className="ms-2 flex-fill">
                          <div className="d-flex align-items-center justify-content-between">
                            <h6 className="fs-medium text-truncate">
                              <Link href="javscript:void(0);">George David</Link>
                            </h6>
                    ...
                    <div className="d-flex justify-content-between">
                      <div className="d-flex align-items-center w-100">
                        ...
                        <div className="ms-2 flex-fill">
                          <div className="d-flex align-items-center justify-content-between">
                            <h6 className="fs-medium text-truncate">
                              <Link href="javscript:void(0);">Aaron Zeen</Link>
                            </h6>
                    ...
                    <div className="d-flex justify-content-between">
                      <div className="d-flex align-items-center w-100">
                        ...
                        <div className="ms-2 flex-fill">
                          <div className="d-flex align-items-center justify-content-between">
                            <h6 className="fs-medium text-truncate">
                              <Link href="javscript:void(0);">Hendry Daniel</Link>
                            </h6>
                            <p className="fs-13">05:30 PM</p>
                          </div>
                          <p className="fs-13">
