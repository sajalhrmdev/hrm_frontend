...
const cards = [
  ...
  { label: "Open", value: "open", icon: "🆕", gradient: "linear-gradient(135deg, #f093fb 0%, #f5576c 100%)", shadow: "rgba(245,87,108,0.35)", key: "OPEN" },
  { label: "In Progress", value: "inProgress", icon: "🔧", gradient: "linear-gradient(135deg, #f6d365 0%, #fda085 100%)", shadow: "rgba(253,160,133,0.35)", key: "IN_PROGRESS" },
  { label: "Resolved", value: "resolved", icon: "✅", gradient: "linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)", shadow: "rgba(79,172,254,0.35)", key: "RESOLVED" },
...
const IssueStats: React.FC<StatsProps> = ({ stats, filter, setFilter }) => {
  return (
    <div className="row g-3 mb-4">
      {cards.map((card) => {
        const isActive = filter === card.key;
        return (
          <div key={card.key} className="col-6 col-lg">
            <div
