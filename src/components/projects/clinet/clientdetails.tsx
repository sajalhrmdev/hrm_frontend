                        ...
                        <div className="col-md-12">
                            <div className="d-flex justify-content-between align-items-center">
                                <h6 className="fw-medium d-inline-flex align-items-center mb-3 mb-sm-0">
                                    <Link href={all_routes.clientlist}>
                    ...
                    <div className="row">
                            ...
                            <div className="card card-bg-1">
                                <div className="card-body p-0">
                                    ...
                                    <div className="text-center px-3 pb-3 border-bottom">
                                        ...
                                        <div>
                                            ...
                                            <div className="row gx-2 mt-3">
                                                ...
                                                <div className="col-6">
                                                    <div>
                                                        <Link href={all_routes.chat} className="btn btn-primary w-100">
                                    ...
                                    <div className="p-3">
                                        <div className="d-flex align-items-center justify-content-between mb-2">
                                            <h6>Social Links</h6>
                                            <Link href="to" className="btn btn-icon btn-sm">
                                                <i className="ti ti-edit" />
                                            </Link>
                                        </div>
                                        <div className="d-flex align-items-center">
                                            <Link href="to" className="me-2">
                        ...
                        <div className="col-xl-8">
                            <div>
                                ...
                                <div className="text-end mb-4 client-details-modal-task">
                                    <div className="dropdown">
                                        <Link
                                            href="to"
...
export default ClientDetailsCompnent
