  ...
  const columns = [
    {
      ...
      sorter: (a: LeaveEmployeeData, b: LeaveEmployeeData) =>
    ...
    },
    {
      ...
      sorter: (a: LeaveEmployeeData, b: LeaveEmployeeData) =>
        a.ApprovedBy.length - b.ApprovedBy.length,
    },
    {
      title: "To",
      dataIndex: "To",
    ...
    },
    {
      ...
      render: (text: string, _record: LeaveEmployeeData) => (
        <div className="dropdown">
          ...
          >
            <span
              className={`rounded-circle ${text === "Approved" ? "bg-transparent-success" : text === "New" ? "bg-transparent-purple" : "bg-transparent-danger"} d-flex justify-content-center align-items-center me-2`}
            >
              <i
                className={`ti ti-point-filled ${text === "Approved" ? "text-success" : text === "New" ? "text-purple" : "text-danger"}`}
              />
            </span>
            {text}
          </button>
            ...
            <div className="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
              ...
              <div className="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                ...
                >
                  ...
                  <ApplyLeaveModal open={open} onClose={() => setOpen(false)} />
                </div>
