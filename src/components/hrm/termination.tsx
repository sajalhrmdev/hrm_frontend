  ...
  const columns = [
    {
      ...
      render: (_text: string, record: TerminationData) => (
        <div className="d-flex align-items-center">
          <Link href={all_routes.invoiceDetails} className="avatar avatar-md me-2">
            <ImageWithBasePath
          ...
          <h6 className="fw-medium">
            <Link href={all_routes.invoiceDetails}>{record.Resigning_Employee}</Link>
          </h6>
        </div>
      ),
            ...
            <div className="modal-content">
              <div className="modal-body text-center">
                ...
                <div className="d-flex justify-content-center">
                  ...
                  <Link href={all_routes.termination} className="btn btn-danger">
                    Yes, Delete
                  </Link>
                </div>
              </div>
