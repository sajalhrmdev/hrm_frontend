                        ...
                        <div className="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                            <div className="me-2 mb-2">
                                <div className="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
                                    <Link href={all_routes.joblist} className="btn btn-icon btn-sm me-1">
                                        <i className="ti ti-list-tree" />
                                    </Link>
                                    <Link
                                        href={all_routes.jobgrid}
                                    ...
                                    <div className="card bg-light">
                                        <div className="card-body p-3">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 className="fw-medium mb-1 text-truncate">
                                                        <Link href="#">Network Engineer</Link>
                                                    </h6>
                                                    <p className="fs-12 text-gray fw-normal">25 Applicants</p>
                                                </div>
                                            </div>
                                    ...
                                    <div className="card bg-light">
                                        <div className="card-body p-3">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 className="fw-medium mb-1 text-truncate">
                                                        <Link href="#">Laravel Developer</Link>
                                                    </h6>
                                                    <p className="fs-12 text-gray fw-normal">25 Applicants</p>
                                                </div>
                                            </div>
                                    ...
                                    <div className="card bg-light">
                                        <div className="card-body p-3">
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 className="fw-medium mb-1 text-truncate">
                                                        <Link href="#">Node js Developer</Link>
                                                    </h6>
                                                    <p className="fs-12 text-gray fw-normal">25 Applicants</p>
                                                </div>
                                            </div>
                                ...
                                <div>
                                    <div className="row g-2">
                                        <div className="col-12">
                                            <Link href={all_routes.jobgrid} data-bs-dismiss="modal" className="btn btn-dark w-100">
                                                Back to List
                                            </Link>
                                        </div>
                                    </div>
