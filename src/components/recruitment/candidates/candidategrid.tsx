                        ...
                        <div className="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                            <div className="me-2 mb-2">
                                <div className="d-flex align-items-center border bg-white rounded p-1 me-2 icon-list">
                                    ...
                                    <Link href={all_routes.candidateslist} className="btn btn-icon btn-sm me-1">
                                        <i className="ti ti-list-tree" />
                                    </Link>
                                    <Link
                                        href={all_routes.candidatesGrid}
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="pipeline-list candidates border-0 mb-0">
                                        <ul className="mb-0">
                                            ...
                                            <li>
                                                <Link href="#" className="bg-grat-100">
                                                    Interviewed
                                                </Link>
                                            </li>
                                            <li>
                            ...
                            <div className="card">
                                ...
                                <div className="card-footer">
                                    <div className="d-flex align-items-center justify-content-end">
                                        <Link href="#" className="btn btn-dark me-3">
                                            Reject
                                        </Link>
                                        <Link href="#" className="btn btn-primary">
                                            Move to Next Stage
...
export default CandidateGridComponent
