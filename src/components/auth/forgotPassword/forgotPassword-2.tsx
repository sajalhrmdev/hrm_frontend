...
const ForgotPassword2Component = () => {
  const routes = all_routes;
  const navigation = useRouter();

  const navigationPath = () => {
    navigation.push(routes.resetPassword2);
  };
                    ...
                    <div className="">
                      ...
                      <div className="text-center">
                        <h6 className="fw-normal text-dark mb-0">
                          Return to
                          <Link href={all_routes.login2} className="hover-a">
                            Sign In
                          </Link>
                        </h6>
                      </div>
...
export default ForgotPassword2Component;
