          ...
          <div className="card-body">
            ...
            >
              <div className="avatar avatar-sm me-3 avatar-rounded">
                <ImageWithBasePath src="assets/img/profiles/avatar-01.jpg" alt="Profiles Image" />
              </div>
            ...
            >
              <div className="avatar avatar-sm me-3 avatar-rounded">
                <ImageWithBasePath src="assets/img/profiles/avatar-02.jpg" alt="Profiles Image" />
              </div>
            ...
            >
              <div className="avatar avatar-sm me-3 avatar-rounded">
                <ImageWithBasePath src="assets/img/profiles/avatar-03.jpg" alt="Profiles Image" />
              </div>
            ...
            >
              <div className="avatar avatar-sm me-3 avatar-rounded">
                <ImageWithBasePath src="assets/img/profiles/avatar-04.jpg" alt="Profiles Image" />
              </div>
            ...
            >
              <div className="avatar avatar-sm me-3 avatar-rounded">
                <ImageWithBasePath src="assets/img/profiles/avatar-05.jpg" alt="Profiles Image" />
              </div>
            ...
            >
              <div className="avatar avatar-sm me-3 avatar-rounded">
                <ImageWithBasePath src="assets/img/profiles/avatar-06.jpg" alt="Profiles Image" />
              </div>
            ...
            >
              <div className="avatar avatar-sm me-3 avatar-rounded">
                <ImageWithBasePath src="assets/img/profiles/avatar-07.jpg" alt="Profiles Image" />
              </div>
