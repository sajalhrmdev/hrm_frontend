              ...
              <div className="d-flex align-items-center justify-content-between">
                <div className="avatar-list-stacked avatar-group-sm">
                  ...
                  <span className="fw-semibold mt-2">
                    <Link className="text-success ms-3" href="#">
                      2 Members
                    </Link>
                  </span>
                </div>
            ...
            <div className="p-3 border p-3 bg-white rounded">
              <div className="d-flex align-items-center justify-content-between">
                <div className="d-flex align-items-center">
                  ...
                  />
                  <h5 className="text-nowrap">
                    <Link href="#">Number_Proj Photos</Link>
                  </h5>
                </div>
                <div className="dropdown">
                  <Link
          ...
          <div className="owl-carousel video-section d-flex gap-3">
            <div className="items">
              <div className="position-relative">
                ...
                <Link href="#" className="position-absolute play-group">
